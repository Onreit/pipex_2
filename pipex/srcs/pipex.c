...
/*   Updated: 2022/06/10 21:48:08 by tjalo            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * @brief  Definition de la fonction 
 * @param av  nombre de parametress 
 * @param env  L amosmbndsafksbdfgsg
 * @param ac   lerijgskdjnfgskdjfg
 * @return  sortie inutile 
 */
